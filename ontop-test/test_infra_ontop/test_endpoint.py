...
"""
        ...
        self.assertEqual(int([r.n_types for r in response][0]), 1) # TODO: I feel like this line is wrong, it should be the length of the second result of this for, instead of [0]:
